...
import { getOneQuote } from "../redux/QuoteSlice";
      ...
      >
        <div>
          <Modal.Title className="block md:flex items-center gap-[20px]">
            <div> {singleData?.quote_title} </div>
            <div className="detail text-[12px] md:text-[20px] w-[80%] md:w-full">
              {" "}
              {moment(singleData.quote_date).format("MMMM Do YYYY, h:mm:ss a")}
            </div>
          </Modal.Title>
        </div>
          ...
          <div className="note my-[40px] flex gap-[5px]">
            ...
            <div>
              <div className="mb-[30px]">
                ...
                advised is subject to prevailing parallel market rateat time of
              ...
              <div>
                NOTE: Duty and tax not insive in the rates advised. They will be
                advised when you provide the CIF value and H.S code, We do trust
                that this offer meets your requirements. Please contact us if
              ...
              <ol>
                ...
                <li>
                  <div className="listitem">
                    ...
                    e.g.- special handling,week-end pickup/delivery which has
                ...
                <li>
                  <div className="listitem">
                    ...
                    qoutes is based upon standard roadside only and between
